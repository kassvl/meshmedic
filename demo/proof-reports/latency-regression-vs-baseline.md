...
The signal has held at **993.7** (threshold > 590.8 (3x the learned baseline) for 90s) since 2026-08-19T17:34:51Z.
...
| query | value |
| --- | --- |
| p99-by-version-ms{destination_version="v1"} | 987.7 |
| p99-by-version-ms{destination_version="v2"} | 95.65 |
| p99-by-version-ms{destination_version="unknown"} | NaN |
| request-rate-per-s | 1.552 |
